...
public class OrderProcessorTest {
    ...
    @Test(description = "BP7 - Member PLATINUM, co coupon SALE10, tong sau giam < 500k, van tinh phi ship ONLINE")
    @Story("PLATINUM + SALE10 with online shipping")
    @Severity(SeverityLevel.NORMAL)
    public void testPlatinum_WithSale10_HasOnlineShipping() {
        List<OrderProcessor.Item> items = items(600_000);
        ...
        Allure.step("PLATINUM + SALE10, tong sau giam < 500k nen tinh phi ship ONLINE 10k");
